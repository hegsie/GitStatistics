...
namespace Gnu.Getopt
{
    ...
    public class Getopt
    {
        ...
        {
            var bottom = firstNonopt;
            var middle = lastNonopt;
            var top = optind;
            string tem;
        ...
        private int checkLongOption()
        {
            ...
            // matches
            for (var i = 0; i < longOptions.Length; i++)
            ...
            if (ambig && !exact)
            {
                if (opterr)
                {
                    ...
                    Console.Error.WriteLine(@"{0}: option '{1}' is ambiguous", msgArgs);
                }
                    ...
                    else
                    {
                        if (opterr)
                        {
                            ...
                            if (argv[optind - 1].StartsWith("--"))
                            {
                                ...
                                Console.Error.WriteLine("{0}: option ''--{1}'' doesn't allow an argument",
                                    msgArgs);
                            }
                            // +option or -option
                            else
                            {
                                ...
                                Console.Error.WriteLine("{0}: option ''{1}{2}'' doesn't allow an argument",
                                    msgArgs);
                            }
                        }
                ...
                else if (pfound.HasArg == Argument.Required)
                {
                    ...
                    else
                    {
                        if (opterr)
                        {
                            ...
                            Console.Error.WriteLine("{0}: option ''{1}'' requires an argument", msgArgs);
                        }
                              ...
                              || optstring.IndexOf(nextchar[0]) == -1)
                {
                    if (opterr)
                    {
                        if (argv[optind].StartsWith("--"))
                        {
                            ...
                            Console.Error.WriteLine("{0}: unrecognized option ''--{1}''", msgArgs);
                        }
                        else
                        {
                            object[] msgArgs =
                            ...
                            Console.Error.WriteLine("{0}: unrecognized option ''{1}{2}''", msgArgs);
                        }
                    }
            ...
            if (temp == null || c2 == ':')
            {
                if (opterr)
                {
                    if (posixlyCorrect)
                    {
                        ...
                        Console.Error.WriteLine(@"{0}: illegal option -- {1}", msgArgs);
                    }
                    else
                    {
                        object[] msgArgs =
                        ...
                        Console.Error.WriteLine(@"{0}: invalid option -- {1}", msgArgs);
                    }
                }
            ...
            if (temp[0] == 'W' && temp.Length > 1 && temp[1] == ';')
            {
                ...
                else if (optind == argv.Length)
                {
                    if (opterr)
                    {
                        ...
                        Console.Error.WriteLine(@"{0}: option requires an argument -- {1}", msgArgs);
                    }
                        ...
                        if (posixlyCorrect && optarg.Equals("--"))
                        {
                            ...
                            if (optind == argv.Length)
                            {
                                if (opterr)
                                {
                                    ...
                                    Console.Error.WriteLine(@"{0}: option requires an argument -- {1}",
                                        msgArgs);
                                }
